    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('midl_name', models.CharField(blank=True, max_length=255, null=True, verbose_name='Отчество')),
                ...
                ('photo', models.FileField(blank=True, null=True, upload_to='user_files/', verbose_name='Фотография профиля')),
                ...
                ('telegram_id', models.CharField(blank=True, max_length=255, null=True, verbose_name='Телеграм')),
